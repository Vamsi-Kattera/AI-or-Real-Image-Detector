...
st.title("AI OR REAL IMAGE FINDER")
...
if upload_file:
    ...
    if pred < 0.5:
        ...
        description =  "This image is AI-generated using AI techniques."
    else:
        result = "REAL"
        confidence = pred * 100
        description = "This image is real, containing natural persons, places, or objects."
